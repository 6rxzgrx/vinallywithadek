...
export const tags = {
  ...
  Redash: {
    ...
    icon: (
      ...
      >
        ...
        <defs />
        <g id='redash-logo' stroke='none' strokeWidth='1' fill='none' fillRule='evenodd'>
          <g id='Group-5' transform='translate(6.000000, 1.000000)' fillRule='nonzero'>
            <path
  ...
  Vercel: {
    ...
    icon: (
      <svg xmlns='http://www.w3.org/2000/svg' fill='white' height='17px' viewBox='0 0 24 24'>
